...
const Footer: React.FC = () => {
    return(
        <footer className="bg-clas-negro p-4">
            <div className="flex flex-col p-4 gap-7">
                    ...
                    <div className="flex flex-col gap-4 items-start">
                        ...
                        <div className="flex w-full bg-clas-gris/30 rounded-lg px-2 py-1">
                            <input
                                ...
                                className="flex-1 bg-transparent border-none outline-none text-clas-gris"
                            >
                            </input>
                            <button className="rounded-lg p-2 text-clas hover:bg-clas-negro focus:ring-2 focus:ring-clas"> {/* TODO: Hacer que este botón funcione */}
                ...
                <div className="flex flex-wrap w-full justify-end items-center align-right">
