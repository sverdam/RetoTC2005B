    ...
    return (
        <div className="flex items-center">
            <NavLink
                ...
                className={`inline-flex items-center justify-end text-white font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 transition focus:outline-none focus:ring-offset-2 ${!color
