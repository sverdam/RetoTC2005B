...
const PaywallPage: React.FC = () => {
    ...
    return(
        <div className="flex flex-col bg-clas-gris/10 pb-10 items-center">
            <div className="w-screen flex flex-col items-center justify-center gap-5 bg-[radial-gradient(circle,_rgba(59,130,246,0.45)_0%,_rgba(59,130,246,0.18)_15%,_white_35%)]">
